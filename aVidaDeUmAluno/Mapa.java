...
class Mapa {
    ...
    private void inicializarSalas() {
        ...
        Laboratorio1.setNpcs(new Npc("Leonardo", "Achou que ia passar sem fazer nada?\nEu vou passar é cerol!!!!"));
        ...
        sala2.setItemNecessario("Chave Dourada");
    ...
    public boolean compararSalas(String nomeSala) {
        return salas.containsKey(nomeSala);
    }
