...
class Mapa {
    ...
    private void inicializarSalas() {
        ...
        Sala Laboratorio1 = new Sala("Laboratorio1", "Você está em um Laboratorio");
        ...
        Sala Laboratorio2 = new Sala("Laboratorio2", "Você está em um Laboratorio.");
        ...
        cantina.adicionarItem(new Item("Café"));
